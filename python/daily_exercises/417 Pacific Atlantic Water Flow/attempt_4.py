...
class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        def dfs(start_row, start_column, input_set):
            ...
            while stack:
                ...
                for row_move, column_move in moves:
                    ...
                    if new_row >= 0 and new_row < rows and new_column >= 0 and new_column < columns and (new_row, new_column) not in input_set:
        ...
        both = atlantic_set.intersection(pacific_set)
