...
class Solution:
    ...
    def hasAllCodes(self, s: str, k: int) -> bool:
        ...
        all_one = all_possible_combinations - 1

        all_possible_combinations_list = []
        hash_value = 0
        ...
        while True:
            ...
            hash_value = ((hash_value << 1) & all_one) | substring[0]

            if hash_value not in all_possible_combinations_dic:
